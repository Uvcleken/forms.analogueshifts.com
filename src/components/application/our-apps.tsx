      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <div className="h-[197px] border-r border-primary-boulder100"></div>
            <div className="flex flex-col w-max items-center">
              <div className="py-1 w-max large:mb-8 mb-6 px-4 rounded-full bg-background-darkYellow/10">
                <p className="text-xs font-medium text-background-darkYellow">
