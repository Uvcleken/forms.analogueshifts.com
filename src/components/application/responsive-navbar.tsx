      ...
      {open && (
        ...
        >
          <div className="pt-7 pb-5 px-8 w-full flex-col flex gap-8">
            ...
            <ResponsiveNavLink href="https://www.analogueshifts.com/jobs">
              Jobs
            </ResponsiveNavLink>
            ...
            {user ? (
              <>
                <ResponsiveNavLink href="/forms">
                  Manage Forms
                </ResponsiveNavLink>
                <ResponsiveNavLink href="/forms/create">
                  Create Form
                </ResponsiveNavLink>
              ...
              <>
                <ResponsiveNavLink href="https://auth.analogueshifts.app?app=forms">
                  Login
                </ResponsiveNavLink>
                <ResponsiveNavLink href="https://auth.analogueshifts.app?app=forms">
                  Sign Up
