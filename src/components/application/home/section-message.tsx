...
export default function SectionMessage({
  ...
  return (
    <div className="w-max max-w-full flex flex-col">
      <h3
        className={`section-tittle overflow-hidden large:text-[32px] tablet:text-xl text-2xl tablet:leading-8 leading-10 mb-7 large:mb-[38px] font-semibold large:leading-[64px] text-black`}
      >
        {title}{" "}
