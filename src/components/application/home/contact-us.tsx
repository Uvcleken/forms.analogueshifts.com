...
export default function ContactUs() {
  ...
  return (
    <section className="w-full large:pl-[112px] large:pr-[185px] tablet:px-6 pl-20 pr-[153px] gap-20 large:gap-[118px] h-max bg-white items-center overflow-hidden large:pb-[130px] large:pt-[168px] tablet:py-14 py-24 tablet:flex flex-col tablet:gap-10 grid grid-cols-2">
