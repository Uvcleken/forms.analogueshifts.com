            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                ...
                <div className=" px-4 pb-6 pt-4 sm:flex sm:flex-row-reverse sm:px-6">
                  ...
                  <button
                    type="button"
                    className="mt-3 inline-flex border w-full items-center h-10 px-8 rounded-xl justify-center py-2 text-xs font-semibold text-primary-boulder400 sm:mt-0 sm:w-auto"
                    onClick={close}
                    ref={cancelButtonRef}
                  >
                    Cancel
